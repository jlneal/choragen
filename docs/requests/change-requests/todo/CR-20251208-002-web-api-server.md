...
- [ ] `@choragen/web` package created with Next.js 14
- [ ] tRPC router with all core routers (chains, tasks, requests, sessions, metrics, config)
- [ ] Read procedures for listing and getting entities
- [ ] Write procedures for create/update/delete operations
- [ ] Zod schemas for all inputs
- [ ] Error handling with proper tRPC errors
